...
type IconType = FooterContactItem["icon"] | FooterData["social"][number]["type"]
...
} satisfies Record<IconType, { viewBox: string; path: string }>
                ...
                {footer.social.map((item) => (
                  ...
                  >
                    <a href={item.href} aria-label={item.label}>
                      <SvgIcon type={item.type} dataIcon="inline-start" />
                    </a>
                  </Button>
                ))}
              </div>
