...
function phoneField(id, label, options = {}) {
...
function choiceGroup(id, label, options, inputType, width = "half") {
  return {
    kind: "choice-group",
    id: `job-${id}`,
...
function yesNoGroup(id, label, width = "full") {
  return choiceGroup(id, label, yesNoOptions, "radio", width);
}
function section(id, lines, level = 2) {
  return {
    kind: "section",
    id: `job-section-${id}`,
    lines,
...
function educationFields(prefix, title) {
  return [
...
const pannaJobApplicationData = {
  intro: {
    title: "JOIN OUR TEAM!",
    underline: {
      src: pannaImage("2024/10/MANCHA.png"),
      width: 361,
      height: 44
    },
...
export { pannaJobApplicationData as p };
