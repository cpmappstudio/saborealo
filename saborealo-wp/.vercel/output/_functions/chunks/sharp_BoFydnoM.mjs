import { A as AstroError, O as MissingSharp } from './entrypoint_DN3GfvOX.mjs';
import { b as baseService, p as parseQuality } from './generic_U0__42mR.mjs';
...
async function loadSharp() {
  let sharpImport;
  try {
    sharpImport = (await import('./index_zW1wIC45.mjs').then(n => n.i)).default;
  } catch {
